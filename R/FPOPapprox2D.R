#' @title data_genDp
#'  
#' @description Generation of data of dimension p with a given values of means and changepoints
#' 
...
data_genDp <- function(p, n, chpts = NULL, means = matrix(0, ncol = 1, nrow = p), noise = 1){
  #---stop---#
