...
png("Plot FPOP2 Exclusions data10^5.png",  width = 1500, height = 1000)
...
write.table(c(v_mean_plot, 0), "FPOP2 Mean number of exclusions data10^5.txt", row.names = FALSE,col.names = FALSE ) 
