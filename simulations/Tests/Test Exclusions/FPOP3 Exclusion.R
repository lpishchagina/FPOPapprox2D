#############################################################################################
#############################################################################################
##                           Test Exclusions One simulation: FPOP3                         ##
...
png("Plot FPOP3 Exclusions data10^5.png",  width = 1500, height = 1000)
plot(c(0, max_length_interval), c(0, max_quantity_exclusion), main = "FPOP3: The number of exclusion in the interval", xlab = "Time interval", ylab =  "Number of exclusions", type = "n")
...
write.table(c(v_mean_plot, 0), "FPOP3 Mean number of exclusions data10^5.txt", row.names = FALSE,col.names = FALSE ) 