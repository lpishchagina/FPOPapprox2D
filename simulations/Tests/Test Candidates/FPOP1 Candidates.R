...
######################################
png(filename = "Plot FPOP1 Candidats data10^5 iter100.png",  width = 1500, height = 1000)
...
dev.off()
write.table(means_candidates, "FPOP1 Candidates  data10^5 iter100.txt",  row.names = FALSE,col.names = FALSE  ) 
