...
fname <- "PLOT FPOP 10^4 MultiTest Candidates.png"

f1name <- "PLOT FPOP1 10^4 MultiTest Candidates.png"
f2name <- "PLOT FPOP2 10^4 MultiTest Candidates.png"
f3name <- "PLOT FPOP3 10^4 MultiTest Candidates.png"
...
dimension <- c("dim 2","dim 3","dim 4","dim 5","dim 6","dim 7","dim 8","dim 9","dim 10","dim 12","dim 15")
...
PLOT_dim = list()
PLOT_dim[[1]] <- ggplot(F1, aes(Time))+geom_line(aes(y = F1C[,12], color = "dim 15"), size = 1)+geom_line(aes(y = F1C[,11], color = "dim 12"), size = 1)+geom_line(aes(y = F1C[,10], color = "dim 10"), size = 1)+geom_line(aes(y = F1C[,9], color = "dim 9"), size = 1)+geom_line(aes(y = F1C[,8], color = "dim 8"), size = 1)+geom_line(aes(y = F1C[,7], color = "dim 7"), size = 1)+geom_line(aes(y = F1C[,6], color = "dim 6"), size = 1)+geom_line(aes(y = F1C[,5], color = "dim 5"), size = 1)+geom_line(aes(y = F1C[,4], color = "dim 4"), size = 1)+geom_line(aes(y = F1C[,3], color = "dim 3"), size = 1)+geom_line(aes(y = F1C[,2], color = "dim 2"), size = 2)+labs( x = "Time", y = "Number of candidates being considered", title ="FPOP1:Candidates")+theme(legend.position = c(0, 1),legend.justification = c(0, 1))
PLOT_dim[[2]] <- ggplot(F2, aes(Time))+geom_line(aes(y = F2C[,12], color = "dim 15"), size = 1)+geom_line(aes(y = F2C[,11], color = "dim 12"), size = 1)+geom_line(aes(y = F2C[,10], color = "dim 10"), size = 1)+geom_line(aes(y = F2C[,9], color = "dim 9"), size = 1)+geom_line(aes(y = F2C[,8], color = "dim 8"), size = 1)+geom_line(aes(y = F2C[,7], color = "dim 7"), size = 1)+geom_line(aes(y = F2C[,6], color = "dim 6"), size = 1)+geom_line(aes(y = F2C[,5], color = "dim 5"), size = 1)+geom_line(aes(y = F2C[,4], color = "dim 4"), size = 1)+geom_line(aes(y = F2C[,3], color = "dim 3"), size = 1)+geom_line(aes(y = F2C[,2], color = "dim 2"), size = 2)+labs( x = "Time", y = "Number of candidates being considered", title ="FPOP2:Candidates")+theme(legend.position = c(0, 1),legend.justification = c(0, 1))
PLOT_dim[[3]] <- ggplot(F3, aes(Time))+geom_line(aes(y = F3C[,12], color = "dim 15"), size = 1)+geom_line(aes(y = F3C[,11], color = "dim 12"), size = 1)+geom_line(aes(y = F3C[,10], color = "dim 10"), size = 1)+geom_line(aes(y = F3C[,9], color = "dim 9"), size = 1)+geom_line(aes(y = F3C[,8], color = "dim 8"), size = 1)+geom_line(aes(y = F3C[,7], color = "dim 7"), size = 1)+geom_line(aes(y = F3C[,6], color = "dim 6"), size = 1)+geom_line(aes(y = F3C[,5], color = "dim 5"), size = 1)+geom_line(aes(y = F3C[,4], color = "dim 4"), size = 1)+geom_line(aes(y = F3C[,3], color = "dim 3"), size = 1)+geom_line(aes(y = F3C[,2], color = "dim 2"), size = 2)+labs( x = "Time", y = "Number of candidates being considered", title ="FPOP3:Candidates")+theme(legend.position = c(0, 1),legend.justification = c(0, 1))
...
Fdim15 = data.frame(Time,F1C[,12],F2C[,12],F3C[,12])
Fdim12 = data.frame(Time,F1C[,11],F2C[,11],F3C[,11])
...
PLOT_FPOP[[10]] <- ggplot(Fdim10, aes(Time))+geom_line(aes(y = F1C[,10], color = "FPOP1"), size = 1)+geom_line(aes(y = F2C[,10], color = "FPOP2"), size = 1)+geom_line(aes(y = F3C[,10], color = "FPOP3"), size = 1)+labs( x = "Time", y = "Number of candidates being considered", title ="Dimension 10: Candidates")+theme(legend.position = c(0, 1),legend.justification = c(0, 1))
PLOT_FPOP[[11]] <- ggplot(Fdim12, aes(Time))+geom_line(aes(y = F1C[,11], color = "FPOP1"), size = 1)+geom_line(aes(y = F2C[,11], color = "FPOP2"), size = 1)+geom_line(aes(y = F3C[,11], color = "FPOP3"), size = 1)+labs( x = "Time", y = "Number of candidates being considered", title ="Dimension 12: Candidates")+theme(legend.position = c(0, 1),legend.justification = c(0, 1))
PLOT_FPOP[[1]] <- ggplot(Fdim15, aes(Time))+geom_line(aes(y = F1C[,12], color = "FPOP1"), size = 1)+geom_line(aes(y = F2C[,12], color = "FPOP2"), size = 1)+geom_line(aes(y = F3C[,12], color = "FPOP3"), size = 1)+labs( x = "Time", y = "Number of candidates being considered", title ="Dimension 15 Candidates")+theme(legend.position = c(0, 1),legend.justification = c(0, 1))

png(filename = "dim 2 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[2]],ncol = 1)
dev.off()

png(filename = "dim 3 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[3]],ncol = 1)
dev.off()

png(filename = "dim 4 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[4]],ncol = 1)
dev.off()

png(filename = "dim 5 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[5]],ncol = 1)
dev.off()

png(filename = "dim 6 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[6]],ncol = 1)
dev.off()

png(filename = "dim 7 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[7]],ncol = 1)
dev.off()

png(filename = "dim 8 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[8]],ncol = 1)
dev.off()

png(filename = "dim 9 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[9]],ncol = 1)
dev.off()

png(filename = "dim 10 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[10]],ncol = 1)
dev.off()

png(filename = "dim 12 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[11]],ncol = 1)
dev.off()

png(filename = "dim 15 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[1]],ncol = 1)
dev.off()

png(filename = "dim 2-15 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
...
png(filename = "dim 2-5 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[2]],PLOT_FPOP[[3]],PLOT_FPOP[[4]],PLOT_FPOP[[5]],ncol = 1)
dev.off()

png(filename = "dim 6-9 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
ggarrange(PLOT_FPOP[[6]],PLOT_FPOP[[7]],PLOT_FPOP[[8]],PLOT_FPOP[[9]],ncol = 1)
dev.off()

png(filename = "dim 10,12,15 PLOT FPOP 10^4 MultiTest Candidates.png",  width = 1500, height = 1000)
