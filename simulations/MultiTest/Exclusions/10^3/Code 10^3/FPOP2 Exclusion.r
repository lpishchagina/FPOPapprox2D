#############################################################################################
#############################################################################################
##                           Test Exclusions One simulation: FPOP                          ##
...
png("dim 15 Plot FPOP2 Exclusions data10^3.png",  width = 1500, height = 1000)
plot(c(0, max_length_interval), c(0, max_quantity_exclusion), main = "Dimension 15 FPOP2: The number of exclusion in the interval", xlab = "Time interval", ylab =  "Number of exclusions", type = "n")
...
write.table(c(v_mean_plot, 0), "dim 15 10^3 FPOP2 Mean number of exclusions.txt", row.names = FALSE,col.names = FALSE ) 
