...
png("dim 2 10^3 Plot FPOP3 Exclusions.png",  width = 1500, height = 1000)
plot(c(0, max_length_interval), c(0, max_quantity_exclusion), main = "Dimension 2 FPOP3: The number of exclusion in the interval", xlab = "Time interval", ylab =  "Number of exclusions", type = "n")
...
write.table(c(v_mean_plot, 0), "dim 2 10^3 FPOP3 Mean number of exclusions.txt", row.names = FALSE,col.names = FALSE ) 
