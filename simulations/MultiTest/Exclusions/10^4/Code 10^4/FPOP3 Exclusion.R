...
png("dim 2 10^4 Plot FPOP3 Exclusions.png",  width = 1500, height = 1000)
...
write.table(c(v_mean_plot, 0), "dim 2 10^4 FPOP3 Mean number of exclusions.txt", row.names = FALSE,col.names = FALSE ) 
