...
//accessory*********************************************************************
unsigned int Geom2Dp::get_p()const{return p;}

unsigned int Geom2Dp::get_label_t()const{return label_t;}

std::list<DiskDp> Geom2Dp::get_disks_t_1()const{return disks_t_1;}
...
//InitialGeometry***************************************************************
void Geom2Dp::InitialGeometry(unsigned int dim, unsigned int t, const std::list<DiskDp> &disks){
  label_t = t;
  disks_t_1.clear();
  disks_t_1 = disks;
}
...
//UpdateGeometry****************************************************************
void Geom2Dp::UpdateGeometry(const DiskDp &disk_t){
  //Intersection
